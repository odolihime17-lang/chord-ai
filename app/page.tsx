    ...
    <main className="min-h-screen bg-slate-50 pb-12 font-sans">
      <div className="max-w-md mx-auto bg-white min-h-screen shadow-xl border-x border-slate-200">
        ...
        <header className="p-5 bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-700 text-white sticky top-0 z-20 shadow-lg">
          ...
          {/* Tabs */}
          <div className="flex mt-4 bg-black/10 rounded-lg p-1">
            <button
              onClick={() => setActiveTab("search")}
              className={`flex-1 py-1.5 text-xs font-bold rounded-md transition-all ${activeTab === "search" ? "bg-white text-blue-700 shadow-sm" : "text-white/70 hover:text-white"
                }`}
            >
              検索
            </button>
            <button
              ...
              className={`flex-1 py-1.5 text-xs font-bold rounded-md transition-all ${activeTab === "history" ? "bg-white text-blue-700 shadow-sm" : "text-white/70 hover:text-white"
                }`}
            >
              履歴
            </button>
